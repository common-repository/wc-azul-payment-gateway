...
= My prices are in USD (or other currency), how can i charge in DOP (Dominican Peso) ? =
...
* Initial Release
= 2.0.0 =
* Exchange Rate support. Now you can configure your store in other currencies and the plugin will convert in realtime the exchange rate.
